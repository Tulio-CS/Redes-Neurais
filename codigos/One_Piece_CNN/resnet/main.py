...
data_path = "D:/GitHub/OPCNN/10_classes/"   #Caminho para o diretorio com as imagens 
save_path = "D:/GitHub/OPCNN/resnet/"       #Caminho onde serao salvos os arquivos gerados
...
train_ds = tf.keras.utils.image_dataset_from_directory(
    ...
    data_path,                               #Caminnho para o diretorio com as imagens
...
output = tfl.Dense(len(class_names), activation='softmax')(dl1)
